...
Chat) und für die CustomTkinter-Oberflächen. Der gemeinsame Kern und die
komplette Weboberfläche liegen ebenfalls in Python (Ordner `kern/` und
`web/`). Es gibt keinen Rust-Anteil mehr.
...
selbst steht nur einmal, nämlich im Python-Kern.
