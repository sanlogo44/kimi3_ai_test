...
starten; der Chat ist deaktiviert und zeigt einen Hinweis.
...
2. **Venv anlegen** (`venv/`).
3. **App-Abhängigkeiten** aus `requirements.txt` (customtkinter, matplotlib, pyyaml, flask – **keine** AI-Bibliotheken).
4. **Anwendung starten** im gewählten Modus.
